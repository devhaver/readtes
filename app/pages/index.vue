...
const colorSwatches = [
  ...
  { name: 'surface-white', class: 'bg-surface-white border border-border-subtle' },
  { name: 'surface-light', class: 'bg-surface-light border border-border-subtle' },
  { name: 'surface-warm', class: 'bg-surface-warm border border-border-subtle' },
    ...
    <main class="mx-auto max-w-3xl space-y-10 px-6 py-10">
      <section>
        ...
        <div class="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3">
          ...
          >
            <div
              class="h-16 w-full rounded-card"
              :class="swatch.class"
            />
      ...
      <section>
        ...
        <div class="mt-4 space-y-3">
          ...
          <div class="rounded-card border border-(--border) bg-(--surface-raised) p-4">
            --surface-raised
          </div>
