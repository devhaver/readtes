...
describe("extractAnchors", () => {
  it("extracts a single Ohr Penimi marker", () => {
    const html =
      '<p>לפני הכל <i data-commentator="Ohr Penimi" data-label="א" data-order="1"></i> היה אור.</p>';
  ...
  it("extracts multiple markers per segment, in order of appearance", () => {
    const html =
      '<p>א <i data-commentator="Ohr Penimi" data-label="א" data-order="1"></i> ב <i data-commentator="Ohr Penimi" data-label="ל" data-order="12"></i> ג</p>';
  ...
  it("extracts a marker at the very start of the string", () => {
    const html =
      '<i data-commentator="Ohr Penimi" data-label="א" data-order="1"></i> תחילת הטקסט.';
  ...
  it("extracts a marker at the very end of the string", () => {
    const html =
      'סוף הטקסט <i data-commentator="Ohr Penimi" data-label="ל" data-order="12"></i>';
  ...
  it("tolerates commentators other than Ohr Penimi, capturing the name for callers to filter", () => {
    const html =
      '<i data-commentator="Histaklut Pnimit" data-label="א" data-order="1"></i>';
...
describe("normalizeAnchors", () => {
  ...
  it("normalizes multiple markers within surrounding text", () => {
    const html =
      'לפני <i data-commentator="Ohr Penimi" data-label="א" data-order="1"></i> אמצע <i data-commentator="Ohr Penimi" data-label="ל" data-order="12"></i> אחרי';
...
describe("stripLeadingItemNumber", () => {
  it("strips a single-digit number with no space", () => {
    expect(stripLeadingItemNumber("1.Text")).toEqual({
      number: 1,
      text: "Text",
    });
  });
  ...
  it("strips a two-digit number followed by a space", () => {
    expect(stripLeadingItemNumber("12. Text")).toEqual({
      number: 12,
      text: "Text",
    });
  });
